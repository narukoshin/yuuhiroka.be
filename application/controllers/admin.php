<?php
    ...
    class admin extends controller{
        ...
        public static function dashboard(){
            ...
            $view = __DIR__ . '/../views/dashboard/index.html';
            if(!file_exists($view)){echo json_encode(['error' => 'file in views not found!']);exit;}
            $view = file_get_contents($view);
            $view = strtr($view, $options);
            echo $view;
        ...
        public function profile(){
            return static::view('dashboard/profile');
        }
        public function users(){
            return static::view('dashboard/users');
        }
        /**
         * Failed logins page
         * 
        ...
        public function failedLogins(){
            ...
            $user = static::isUserLogged();
            if (!$user) return static::redirect('admin');
            return static::view('dashboard/failed_logins', [
                '{site.url}'    => config::get()->site_url,
                '{log.out}'     => config::get()->site_url . '/admin/logout/' . $user->hash,
            ]);
        }
        public function messages(){
            return static::view('dashboard/messages');
        }
        public function config(){
            return static::view('dashboard/config');
        }
    }